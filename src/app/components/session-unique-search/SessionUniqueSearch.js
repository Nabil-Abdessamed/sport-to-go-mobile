...
import HeaderRight from "../session-regular-search/SessionReagularSearchHeader";
...
export default function SessionUniqueSearch() {
        ...
        {searchMode === 1 ? (
          ...
          <STGScrollView>
            <STGScrollViewBody>
              ...
              />
              {/* Date */}
              <View style={SessionRegularStyles.searchDateContainer}>
                <Text style={SessionRegularStyles.searchDateText}>
                  {t("common:date")}
                </Text>
                <Switch
                  value={withDate}
